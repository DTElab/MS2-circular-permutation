#!/bin/bash
java -jar /usr/share/java/trimmomatic-0.39.jar PE 001_S1_L001_R1_001.fastq.gz 001_S1_L001_R2_001.fastq.gz s1_pe s1_se s2_pe s2_se SLIDINGWINDOW:6:15 MINLEN:30
...
java -jar /home/sl/Documents/picard.jar CollectAlignmentSummaryMetrics R=Reference/ref.fasta I=slHTS_filt.bam O=aSL01_ex.txt
samtools view -b -F 4 slHTS_filt.bam > slHTS_map.bam
samtools view slHTS_map.bam |sort|less -S > asl01.txt
